...
#[pyfunction(signature = (data, source_name=None, content_type=None, format=None, max_parse_bytes=None, sheet=None, rows=None, columns=None, limit=None, offset=None))]
fn parse_bytes(
    py: Python<'_>,
    data: &[u8],
